export const ICONS = {
  ...
  warningAmber: "/assets/images/icon/warning-amber.svg",
  errorRed: "/assets/images/icon/error-red.svg",

  unlinkGray: "/assets/images/icon/unlink-gray.svg",
  trashRed: "/assets/images/icon/trash-red.svg",
} as const;
